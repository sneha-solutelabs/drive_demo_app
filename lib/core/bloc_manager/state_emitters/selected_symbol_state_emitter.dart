...
class SelectSymbolsStateEmitter extends BaseStateEmitter<SelectedSymbolEventListener,SelectSymbolCubit>{
  SelectSymbolsStateEmitter(BaseBlocManager blocManager) : super(blocManager);

  @override
  void handleStates({required SelectedSymbolEventListener eventListener, required Object state}) {
